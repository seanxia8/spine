...
# UResNet upweighting method aliases
# -----------------------------------
# Maps string names (in various capitalizations) to integer method codes:
#   0 = vertex,   1 = instance,   2 = class
UPWEIGHT_METHOD = {
    "vertex":   0, "Vertex":   0, "VERTEX":   0, "V": 0,
