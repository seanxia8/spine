def model_dict():
    ...
    models = {
        ...
        # UResNet + Attn
        "uresnet_attn": (uresnet_attn.UResNetAttnSegmentation, uresnet_attn.SegmentationLossAttn),
        ...
        "graph_spice_iter": (graph_spice_iterate.GraphSPICEIter, graph_spice_iterate.GraphSPICEIterLoss),
